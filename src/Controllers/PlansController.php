...
class PlansController extends BaseController {
     ...
     */
    public function getServicePlanListUsingGET (
                $vZM2MToken,
                $aname) 
    {
        ...
        $_queryBuilder = $_queryBuilder.'/plans/{aname}';
        ...
        return $mapper->mapArray($response->body, array(), new Models\ServicePlanResponse());
    }
