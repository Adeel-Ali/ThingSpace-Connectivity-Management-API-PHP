...
class SessionController extends BaseController {
    ...
    /**
     * @var SessionController The reference to *Singleton* instance of this class
     */
     ...
     * @param  Models\SessionResetPasswordRequest $request          Required parameter: Current Password
     * @param  string                          $vZM2MToken       Required parameter: M2M-MC Session Token
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updateResetUsingPUT (
                $request,
                $vZM2MToken) 
    {
        ...
        $_queryBuilder = $_queryBuilder.'/session/password/actions/reset';
        ...
        return $mapper->map($response->body, new Models\SessionResetPasswordResponse());
    }
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createLogoutUsingPOST (
                $vZM2MToken) 
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/session/logout';
        ...
        return $mapper->map($response->body, new Models\LogOutRequest());
    }
        
    /**
     * Initiates a Connectivity Management session and returns a session token required in subsequent API requests.
     * @param  Models\LogInRequest $request     Optional parameter: request
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createLoginUsingPOST (
                $request = NULL) 
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/session/login';
        ...
        return $mapper->map($response->body, new Models\LogInResponse());
    }
