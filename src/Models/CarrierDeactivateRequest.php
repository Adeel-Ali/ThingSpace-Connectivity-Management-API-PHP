...
class CarrierDeactivateRequest implements JsonSerializable {
    ...
    /**
     * @todo Write general description for this property
     * @var bool $etfWaiver public property
     */
    public $etfWaiver;
    ...
    /**
     * @todo Write general description for this property
     * @var string $reasonCode public property
     */
    public $reasonCode;
     ...
     * @param   bool              $etfWaiver      Initialization value for the property $this->etfWaiver   
     * @param   string            $groupName      Initialization value for the property $this->groupName   
     * @param   string            $reasonCode     Initialization value for the property $this->reasonCode  
    ...
    public function __construct()
    {
        if(7 == func_num_args())
        {
            ...
            $this->devices      = func_get_arg(2);
            $this->etfWaiver    = func_get_arg(3);
            $this->groupName    = func_get_arg(4);
            $this->reasonCode   = func_get_arg(5);
